...
interface Props {
  ...
  /** When set, a camera-icon button appears in the composer for picking and sending a photo. The screen owns
   * picking, uploading and dispatching — this component only renders the trigger and the resulting bubbles. */
  onPickImage?: () => void;
...
const Bubble: React.FC<{ msg: ThreadMessage; mine: boolean; showName: boolean; cont: boolean }> =
  React.memo(({ msg, mine, showName, cont }) => {
    ...
    if (msg.type === 'image') {
      return (
        ...
        >
          ...
          <View
            style={[
              { width: 200, height: 200, overflow: 'hidden', backgroundColor: Colors.surfaceDark },
              mine ? RADIUS_OWN : RADIUS_OTHER,
            ]}
          >
            <Image
              source={{ uri: resolveMediaUrl(msg.content) }}
          ...
          style={[
            {
              ...
              backgroundColor: mine ? Ramp.accent[800] : Colors.surfaceDark,
            },
            wrapped && { width: '78%' },
            mine ? RADIUS_OWN : RADIUS_OTHER,
          ]}
        >
          <PrettyText
            ...
            style={{
              fontSize: 14,
              lineHeight: 19.6,
              color: mine ? Ramp.accent[100] : Colors.textPrimary,
            }}
          >
            {msg.content}
          </PrettyText>
    ...
    >
      ...
      >
        <Pressable
          ...
          style={({ pressed }) => ({
            ...
            alignItems: 'center',
            justifyContent: 'center',
            backgroundColor: pressed ? PRESSED : 'transparent',
          })}
        >
      ...
      <View
        style={{
          ...
          paddingTop: 8,
          paddingHorizontal: 12,
          paddingBottom: keyboardUp ? 8 : bottom,
        }}
      >
        {!!onPickImage && (
          <Pressable
